...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/bdb/Makefile.in $(top_srcdir)/configure COPYING \
...
ACLOCAL = ${SHELL} /home/tc/prj/mysql-5.0.27/missing --run aclocal-1.9
ALLOCA = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/tc/prj/mysql-5.0.27/missing --run tar
AR = ar
ARFLAGS = cru
AS = gcc -c
ASSEMBLER_FALSE = 
...
ASSEMBLER_x86_FALSE = 
ASSEMBLER_x86_TRUE = #
AUTOCONF = ${SHELL} /home/tc/prj/mysql-5.0.27/missing --run autoconf
AUTOHEADER = ${SHELL} /home/tc/prj/mysql-5.0.27/missing --run autoheader
AUTOMAKE = ${SHELL} /home/tc/prj/mysql-5.0.27/missing --run automake-1.9
...
CC_VERSION = gcc (GCC) 4.9.1
CFLAGS = -O3 -DDBUG_OFF   
CHECK_PID = /bin/kill -0 $$PID > /dev/null 2> /dev/null
CHMOD = /bin/chmod
CLIENT_EXTRA_LDFLAGS = 
CLIENT_LIBS = -lcrypt -lnsl -lm   -lz 
CMP = /usr/local/bin/cmp
COMPILATION_COMMENT = Source distribution
COMPILE_PSTACK_FALSE = 
COMPILE_PSTACK_TRUE = #
CONF_COMMAND = ./configure '--prefix=/usr/local/mysql' '--without-docs' '--without-bench' '--without-man' '--without-innodb'
CP = /bin/cp
CPP = gcc -E
CPPFLAGS = 
CXX = g++
...
MACHINE_TYPE = x86_64
MAKEINDEX = no
MAKEINFO = ${SHELL} /home/tc/prj/mysql-5.0.27/missing --run makeinfo
...
MYSQL_NO_DASH_VERSION = 5.0.27
MYSQL_SERVER_SUFFIX = 
MYSQL_TCP_PORT = 3306
MYSQL_TCP_PORT_DEFAULT = 3306
MYSQL_UNIX_ADDR = /tmp/mysql.sock
MYSQL_VERSION_ID = 50027
NDB_DEFS = 
NDB_SCI_INCLUDES = 
NDB_SCI_LIBS = 
NDB_SIZEOF_CHAR = 
...
innodb_libs = 
innodb_system_libs = 
install_sh = /home/tc/prj/mysql-5.0.27/install-sh
...
sql_server_dirs = strings mysys dbug extra regex myisam myisammrg heap vio sql
sql_union_dirs =  strings mysys dbug extra regex myisam myisammrg heap vio sql  libmysql  client 
subdirs = 
...
SUBDIRS = . include    \
			cmd-line-utils sql-common \
			 pstack \
			 strings mysys dbug extra regex myisam myisammrg heap vio sql  libmysql  client  scripts  tests \
			netware  \
			 mysql-test support-files  server-tools

DIST_SUBDIRS = . include  zlib \
			cmd-line-utils sql-common \
			 pstack \
			 strings mysys dbug extra regex myisam myisammrg heap vio sql  libmysql  client  scripts  tests SSL\
			BUILD netware os2  \
			 mysql-test support-files  server-tools win
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/bdb $(distdir)/config/ac-macros $(distdir)/include $(distdir)/libmysql $(distdir)/ndb/include
...
linked_client_sources:  linked_libmysql_sources
